...
# %%capture
# !pip install tzlocal!=3.*,>=2.0 # Required to resolve an error with codecarbo. Must be placed before you install codecarbon too
...
MEASURE_INTERVAL = 1
RUNS = 1 # 
DEFAULT_MODEL = "bigscience/T0_3B" # TODO: This is only 3B while testing on a single GPU
device
...
coref_dataset = load_dataset("winograd_wsc")
...
run_model(query, "bigscience_carbon_footprint_colab")
